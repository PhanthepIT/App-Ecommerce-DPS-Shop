...
import 'package:app_ecommerce/controllers/product_controller.dart';
        ...
        appBar: AppBar(
          ...
          actions: [
            Obx(
              ...
              icon: Icon(
                Icons.favorite,
                color: controller.isFav.value ? pink : darkFontGrey,
                )),
            ),
          ],
        ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      VxRating(
                        ...
                        10.heightBox,
                        "${data['p_price']}".numCurrency.text.color(ku).fontFamily(bold).size(18).make(),
                        10.heightBox,
                        Row(
                          children: [
                            ...
                            children: [
                              ...
                              //total row
                                ...
                                children: [
                                  ...
                                  "${controller.totalPrice.value}".numCurrency.text.color(ku).size(16).fontFamily(bold).make(),
                              ...
                              children: List.generate(6, (index) => Column(
                                ...
                                children: [
                                  Image.asset(
                                    ...
                                    10.heightBox,
                                    "\$600".text.color(ku).fontFamily(bold).size(16).make()
                                ],
