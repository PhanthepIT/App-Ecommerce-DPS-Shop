...
import 'package:app_ecommerce/views/orders_screen/components/order_place_details.dart';
import 'package:app_ecommerce/views/orders_screen/components/order_status.dart';
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              orderStatus(
                color: ku,icon: Icons.done, title: "Placed", showDone: data['order_placed']
              ),
              orderStatus(
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          "${data['total_amount']}".text.color(greentree).fontFamily(bold).make(),
                        ],
                      ),
                    ),
                  ],
