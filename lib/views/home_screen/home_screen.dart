...
//import 'package:app_ecommerce/views/home_screen/components/featured_button.dart';
import 'package:app_ecommerce/views/home_screen/search_screen.dart';
// ignore: unused_import
import 'package:app_ecommerce/widgets_common/home_buttons.dart';
              ...
              child: SingleChildScrollView(
                ...
                Align(
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(color: ku),
                    child: Column(
                                ...
                                children: List.generate(featuredData.length, (index) => Column(
                                  ...
                                  children: [
                                    Image.network(
                                      ...
                                      10.heightBox,
                                      "${featuredData[index]['p_price']}".numCurrency.text.color(ku).fontFamily(bold).size(16).make()
                                  ],
                      ...
                      return Column(
                              ...
                              children: [
                                Image.network(
                                  ...
                                  10.heightBox,
                                  "${allproductsdata[index]['p_price']}".numCurrency.text.color(ku).fontFamily(bold).size(16).make(),
                                  10.heightBox,
                              ],
